...
public class IMDbClientTest {
    ...
    @BeforeClass
    public void init() {
        client = new IMDbClient(new IMDbClient.InputStreamsProvider() {
            @Override
    ...
    public void testNameBasics() {
        List<Name> names = client.nameStream().collect(Collectors.toList());
    ...
    public void testTitleAkas() {
        List<TitleAkas> akas = client.titleAkasStream().collect(Collectors.toList());
    ...
    public void testTitleBasics() {
        List<TitleBasics> basics = client.titleBasicsStream().collect(Collectors.toList());
    ...
    public void testTitleCrew() {
        List<TitleCrew> crews = client.titleCrewStream().collect(Collectors.toList());
    ...
    public void testTitleEpisode() {
        List<TitleEpisode> episodes = client.titleEpisodeStream().collect(Collectors.toList());
    ...
    public void testTitlePrincipals() {
        List<TitlePrincipals> principals = client.titlePrincipalsStream().collect(Collectors.toList());
    ...
    public void testTitleRatings(){
        List<TitleRatings> ratings = client.titleRatingsStream().collect(Collectors.toList());
